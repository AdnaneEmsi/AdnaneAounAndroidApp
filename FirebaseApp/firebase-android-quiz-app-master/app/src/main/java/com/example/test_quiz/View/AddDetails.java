    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        update.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(name!=null) {
                    ...
                    mDatabase.child("users").child(Objects.requireNonNull(auth.getUid()))
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(AddDetails.this,"Remis a jour",Toast.LENGTH_SHORT).show();
                            refresh();//Refresh 9
                            finish();
                ...
                }else Toast.makeText(AddDetails.this,"Veuillez entrez un nom valide",Toast.LENGTH_SHORT).show();
            }
        });
